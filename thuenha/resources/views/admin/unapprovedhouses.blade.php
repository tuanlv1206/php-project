            ...
            <div class="col-xs-12">
              <ul class="list-unstyled houses-list">
                ...
                @foreach ($houseList as $house)
                  <li class="list-item">
                    <td>
                        <form action="/xem-tin-de-duyet/{{ $house->id }}" method="POST">
                            {{ csrf_field() }}

                            <button type="submit" id="approve-house-{{ $house->id }}" class="btn btn-danger">
                                <i class="fa fa-btn fa-bell"></i>Xem để duyệt
                            </button>
                        </form>
                    </td>
                    <div class="row">
                      <div class="col-xs-12 col-sm-3">
                        <div class="row">
                          <div class="col-xs-12">
                            <a href="/xem-tin-de-duyet/{{ $house->id }}"><img src="/uploads/avatars/{{$house->avatar }}" alt="thuê nhà"></img></a>
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-12 col-sm-9">
                        <div class="row">
                          <div class="col-xs-12">
                            <a href="/xem-tin-de-duyet/{{ $house->id }}" class="title">{{$house->title}}</a>
                          </div>
                        </div>
                        <div class="row">
                          <div class="col-xs-12">
