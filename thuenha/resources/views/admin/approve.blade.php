...
<div class="container house">
  ...
  <div class="row">
    <div class="col-sm-9 left-panel">
      ...
      {{ Form::open(array('url' => 'duyet-tin/'.$house->id, 'method' => 'POST', 'id' => 'form-update', 'files' => true)) }}
        <div class="row">
          <div class="col-xs-12">
              ...
              <div class="panel-body">
                ...
                <div class="row btn-post">
                  <div class="col-xs-12 text-center">
                    {{ Form::button('Duyệt', array('class' => 'btn btn-success', 'type' => 'submit')) }}
                    {{ Form::button(trans('house/create.cancel'), array('id' => 'btn-cancel-approve', 'class' => 'btn btn-warning btn-cancel')) }}
                  </div>
                </div>
                <div class="row">
                  <div class="col-xs-12">
