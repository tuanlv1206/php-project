...
<div class="container house">
  ...
  <div class="row">
    <div class="col-sm-9 left-panel">
      ...
      {{ Form::open(array('url' => 'huy-duyet-tin/'.$house->id, 'method' => 'POST', 'id' => 'form-update', 'files' => true)) }}
        <div class="row">
          <div class="col-xs-12">
              ...
              <div class="panel-body">
                ...
                <div class="row">
                  <div class="col-xs-4 col-sm-3">
                    <label>{{ trans('house/create.rooms') }}: </label>
                  </div>
                  <div class="col-xs-8 col-sm-3">
                    {{ Form::text('rooms', $house->rooms, array('class' => 'form-control', 'placeholder' => trans('house/create.rooms_hint'))) }}
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xs-8 col-sm-3">
                    {{ Form::text('floors', $house->floors + 0, array('class' => 'form-control', 'placeholder' => trans('house/create.floors_hint'))) }}
                  </div>
                  <div class="facade col-xs-4 col-sm-3">
                    <label>{{ trans('house/create.facade') }}: </label>
                  </div>
                  <div class="facade col-xs-8 col-sm-3">
                    {{ Form::text('facade', $house->facade + 0, array('class' => 'form-control', 'placeholder' => trans('house/create.facade_hint'))) }}
                  </div>
                </div>
                <div class="row">
                  <div class="col-xs-4 col-sm-3">
                  ...
                  <div class="frontline col-xs-8 col-sm-3">
                    {{ Form::text('frontline', $house->frontline + 0, array('class' => 'form-control', 'placeholder' => trans('house/create.frontline_hint'))) }}
                  </div>
                </div>
                ...
                <div class="row btn-post">
                  <div class="col-xs-12 text-center">
                    {{ Form::button('Bỏ duyệt', array('class' => 'btn btn-success', 'type' => 'submit')) }}
                    {{ Form::button(trans('house/create.cancel'), array('id' => 'btn-cancel-disapprove', 'class' => 'btn btn-warning btn-cancel')) }}
                  </div>
                </div>
                <div class="row">
                  <div class="col-xs-12">
