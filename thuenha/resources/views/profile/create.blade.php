...
<div class="container profile">
  <div class="row">
    <div class="col-sm-9 left-panel">
      ...
      {{ Form::open(array('url' => 'dang-ky-ho-so', 'id' => 'form-create', 'files' => true)) }}
        <div class="row">
          <div class="col-xs-12">
              ...
              <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-4">
                    {{ Form::text('name', '', array('class' => 'form-control', 'placeholder' => trans('profile/create.name_hint'))) }}
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-4">
                    {{ Form::text('register_name', Auth::user()->name, array('class' => 'form-control','readonly'=>"readonly", 'placeholder' => trans('profile/create.register_name_hint'))) }}
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-4">
                    {{ Form::text('email', Auth::user()->email, array('class' => 'form-control','readonly'=>"readonly", 'placeholder' => trans('profile/create.email_hint'))) }}
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-4">
                    {{ Form::text('mobile_phone', '', array('class' => 'form-control')) }}
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-4">
                    {{ Form::text('facebook', '', array('class' => 'form-control', 'placeholder' => trans('profile/create.facebook_hint'))) }}
                  </div>
                </div>
                <div class="row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-6 col-md-4">
                    {{ Form::text('skype', '', array('class' => 'form-control', 'placeholder' => trans('profile/create.skype_hint'))) }}
                  </div>
                </div>
                ...
                <div class="row btn-post">
                  <div class="col-xs-12 text-center">
                    {{ Form::button(trans('profile/create.post'), array('class' => 'btn btn-success', 'type' => 'submit')) }}
                    {{ Form::button(trans('profile/create.cancel'), array('id' => 'profile-btn-cancel', 'class' => 'btn btn-danger btn-cancel')) }}
                  </div>
                </div>
              </div>
            </div>
